...
// GetViolationState returns the ViolationState field value if set, zero value otherwise.
func (o *Policy) GetViolationState() string {
	if o == nil || IsNil(o.ViolationState) {
		var ret string
		return ret
	}
...
// GetViolationStateOk returns a tuple with the ViolationState field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetViolationState gets a reference to the given string and assigns it to the ViolationState field.
