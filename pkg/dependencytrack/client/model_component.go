...
type Component struct {
	...
	Filename *string `json:"filename,omitempty" validate:"regexp=^[\\p{Alnum}:/\\\\!@#$%^&{}\\[\\]()_+\\-=\\,.~'\x60 ]{1\\,255}$"`
	Extension *string `json:"extension,omitempty" validate:"regexp=^[\\p{Alnum}!@#$%^&{}\\[\\]()_+\\-=\\,.~'\x60 ]{1\\,255}$"`
	...
	Cpe *string `json:"cpe,omitempty" validate:"regexp=(cpe:2\\.3:[aho\\*\\-](:(((\\?*|\\*?)([a-zA-Z0-9\\-\\._]|(\\\\[\\\\\\*\\?!\"#$$%&'\\(\\)\\+\\,/:;<=>@\\[\\]\\^\x60\\{\\|}~]))+(\\?*|\\*?))|[\\*\\-])){5}(:(([a-zA-Z]{2\\,3}(-([a-zA-Z]{2}|[0-9]{3}))?)|[\\*\\-]))(:(((\\?*|\\*?)([a-zA-Z0-9\\-\\._]|(\\\\[\\\\\\*\\?!\"#$$%&'\\(\\)\\+\\,/:;<=>@\\[\\]\\^\x60\\{\\|}~]))+(\\?*|\\*?))|[\\*\\-])){4})|([c][pP][eE]:/[AHOaho]?(:[A-Za-z0-9\\._\\-~%]*){0\\,6})"`
